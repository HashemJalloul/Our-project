...
const Sidebar = () => {
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const sidebar = document.getElementById("MA-courses-sidebar");
  ...
  return (
    <div className="MA-courses-sidebar" id="MA-courses-sidebar">
      <button class="toggle-button" id="toggle-button">
        <div style={{border:"1px solid #665d5d",cursor:"pointer",borderRadius:"4px"}}>☰</div>
      </button>
      <div class="MA-sidebar-content" id="MA-sidebar-content">
